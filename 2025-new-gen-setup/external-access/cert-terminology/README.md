...
- If HTTP not problem, if HTTPS decryption solves issue t<!--1567 (see specific sub)-->
- If SSH pub/priv key generated by `ssh-keygen`: https://docs.github.com/en/authentication/connecting-to-github-with-ssh/generating-a-new-ssh-key-and-adding-it-to-the-ssh-agent in local
  - SSH, more complex SSL decryption as not a webtraffic HTTPs, we need to access keys: https://blog.fox-it.com/2020/11/11/decrypting-openssh-sessions-for-fun-and-profit/ <!-- stop there-->
...
## Notes on CipherSuites

[Cipher suites](./cipher-suites.md)
<!-- consistent with diagram still actually - stop here - link to /private_script/ /Links-mig-auto-cloud/2025-consolidation/Inbound/README.md#ciphersuites